...
function Payment() {
  ...
  return (
    <div className="pt-24 width:100% bg-rose-200 pb-20">
      <h1 class="mb-4 text-6xl font-extrabold tracking-tight md:text-5xl lg:text-6xl text-center px-8">
        Payment <span className="text-rose-800">GateWay.</span>
      </h1>
      ...
      <div className="flex flex-wrap justify-around">
        ...
        <div className="mx-8 mb-4 xl:w-2/4 lg:w-screen">
          ...
          <h1 className="text-6xl font-bold mb-1">
            <span className="text-rose-800">Escrow</span> 
          </h1>
        ...
        <div className="grow bg-gray-100 shadow-lg rounded-lg mx-8 text-left p-4">
          ...
          <form action="">
            ...
            <button
              ...
              className="block px-3 py-1 mx-auto mt-4 text-white bg-gradient-to-r from-rose-800 to-fuchsia-800 font-medium rounded-full hover:scale-105 transition-all duration-500 ease-in-out"
            >
              Payment Now!
            </button>
          </form>
