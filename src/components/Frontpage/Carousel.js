  ...
  return (
    <div className="text-black rounded-md mt-12 mb-12 mx-auto">
      <div className="text-center">
        <span className="text-2xl md:text-4xl font-bold text-rose-800">
          ...
          >
            {jobs.map((job) => (
              <div key={job.id} className="p-2">
                <div className="bg-rose-100 p-4 rounded-2xl border-[1px] border-rose-800 hover:shadow-custom-kaala h-full flex flex-col transition-all duration-1000 ease-in-out">
