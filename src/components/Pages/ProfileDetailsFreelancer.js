  ...
  return (
    <div className="profile-details pt-20 h-screen bg-gray-100">
      <h2 className="text-3xl font-bold mb-6 text-center">
        <span className="text-rose-800">Welcome! </span>to your profile
      </h2>
      {profile ? (
        <div className="flex">
          ...
          <div className="grow p-6 bg-white shadow-lg rounded-lg mr-5">
            ...
            <div className="text-center">
              <button
                ...
                className="text-white bg-gradient-to-r from-rose-800 to-fuchsia-800 hover:scale-105 font-medium rounded-full text-sm px-5 py-2.5 mt-6 mr-2"
              >
                Edit Profile
              </button>
              <button
                onClick={() => navigate(`/jobs-applied/${user.uid}`)}
                className="text-white bg-gradient-to-r from-rose-800 to-fuchsia-800 hover:scale-105 font-medium rounded-full text-sm px-5 py-2.5 mt-6"
              >
                Jobs Applied
              </button>
            </div>
